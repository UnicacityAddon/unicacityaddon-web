...
<nav id="nav" class="nav">
    <a class="nav-child nav-child-right text-20-400" href="https://github.com/rettichlp/unicacityaddon-addon/releases/download/v<?php echo $latestVersion ?>/UnicacityAddon-<?php echo $latestVersion ?>.jar">Download</a>
    ...
    <a class="nav-child nav-child-right text-20-400" href="https://github.com/rettichlp/unicacityaddon-addon/releases/latest">What's new?</a>
    <a class="nav-child nav-child-right text-20-400" href="https://github.com/rettichlp/unicacityaddon-addon/tree/main">Code</a>
