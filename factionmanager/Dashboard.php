...
<div class="index-first">
    <div class="index-first-content">
        <p class="text-80-700">Faction Manager <span class="text-40-400">v<span
                        style="color: var(--blue)">1.0.0</span></span></p>
        <p class="text-25-300">
            by RettichLP, Ullrich and Dimiikou<br><br>
            This Site is a management Software for <a class="link" href="http://unicacity.de/" target="_blank">UnicaCity</a>
            factions<br>
            Providing Activityproofs and Statistics
        </p>
